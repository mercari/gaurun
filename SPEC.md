...
|platform         |int         |platform(iOS, Android, FCM)              |o       |       |1=iOS, 2=Android, 3=FCM                   |
|message          |string      |message for notification                 |-       |       |required for Android and iOS              |
|body             |string      |body for notification                    |-       |       |required for FCM                          |
|title            |string      |title for notification                   |-       |       |iOS and FCM (required for FCM)            |
