...
To compile from source, you need Go1.8 or later (including `$GOPATH` setup) and [dep](https://github.com/golang/dep) for dependency management. After setup, then clone the source code by running the following command,
